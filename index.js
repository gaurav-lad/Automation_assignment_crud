...
program
    ...
    .option('-b, --browser <path>', 'name of browser to use. defaults to chrome', /^(chrome|firefox)$/i, 'chrome')
...
//Using Faker library to generate random unique names and other values to be used while execution
